...
public static void Test()
{
    ...
    for (int i = 0; i < Inputs.Count; i++)
    {
        ...
        Console.WriteLine($"Input: {PrintMatrix(input)}, ExpectedOutputs: {PrintMatrix(expectedOutput)}, Actual Output: {PrintMatrix(actualOutput)}");
    }
}
